...
public class NethersteelShieldItem extends ShieldItem {
    public NethersteelShieldItem(Item.Properties properties) {
        super(properties);
    }
    ...
    public Multimap<Attribute, AttributeModifier> getAttributeModifiers(EquipmentSlot slot, ItemStack stack) {
        ...
        AttributeModifier attackerBurnTimeMod = new AttributeModifier(BGUtil.SHIELD_BURN_TIME_UUID, "Shield attacker burn time", 2F, AttributeModifier.Operation.ADDITION);
